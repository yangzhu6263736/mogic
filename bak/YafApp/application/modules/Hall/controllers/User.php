...
{
    public function loginAction($user, $passwd, $callback)
    {
        \Mogic\MLog::log("UserController", "indexAction", $user, $passwd);
        \Mogic\DataLeaker::set('userId', 1234);
        $client = \Yaf_Registry::get("client");
        print_R($client);
		call_user_func($callback, "xxxx123");
    }
